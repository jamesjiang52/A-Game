...
${OBJECTDIR}/code/ActiveEffectClass.o: code/ActiveEffectClass.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/ActiveEffectClass.o code/ActiveEffectClass.cpp

${OBJECTDIR}/code/ArmorClass.o: code/ArmorClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/ArmorClass.o code/ArmorClass.cpp

${OBJECTDIR}/code/Armors.o: code/Armors.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Armors.o code/Armors.cpp

${OBJECTDIR}/code/Combat.o: code/Combat.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Combat.o code/Combat.cpp

${OBJECTDIR}/code/DirectionClass.o: code/DirectionClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/DirectionClass.o code/DirectionClass.cpp

${OBJECTDIR}/code/Game.o: code/Game.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Game.o code/Game.cpp

${OBJECTDIR}/code/GenericEnemyClass.o: code/GenericEnemyClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/GenericEnemyClass.o code/GenericEnemyClass.cpp

${OBJECTDIR}/code/InteractableObjectClass.o: code/InteractableObjectClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/InteractableObjectClass.o code/InteractableObjectClass.cpp

${OBJECTDIR}/code/Journal.o: code/Journal.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Journal.o code/Journal.cpp

${OBJECTDIR}/code/LocationClass.o: code/LocationClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/LocationClass.o code/LocationClass.cpp

${OBJECTDIR}/code/MiscObjectClass.o: code/MiscObjectClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/MiscObjectClass.o code/MiscObjectClass.cpp

${OBJECTDIR}/code/MiscObjects.o: code/MiscObjects.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/MiscObjects.o code/MiscObjects.cpp

${OBJECTDIR}/code/PlayerClass.o: code/PlayerClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/PlayerClass.o code/PlayerClass.cpp

${OBJECTDIR}/code/PotionClass.o: code/PotionClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/PotionClass.o code/PotionClass.cpp

${OBJECTDIR}/code/Potions.o: code/Potions.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Potions.o code/Potions.cpp

${OBJECTDIR}/code/Scenes.o: code/Scenes.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Scenes.o code/Scenes.cpp

${OBJECTDIR}/code/ShieldClass.o: code/ShieldClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/ShieldClass.o code/ShieldClass.cpp

${OBJECTDIR}/code/Shields.o: code/Shields.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Shields.o code/Shields.cpp
...
${OBJECTDIR}/code/WeaponClass.o: code/WeaponClass.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/WeaponClass.o code/WeaponClass.cpp

${OBJECTDIR}/code/Weapons.o: code/Weapons.cpp
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Weapons.o code/Weapons.cpp
